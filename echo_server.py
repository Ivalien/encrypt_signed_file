...
def encrypt_file(file_name, key):
    ...
    with open(file_name + ".enc", 'wb') as fo:
        fo.write(enc)
#Encriptacion del archivo que recibio el server
encrypt_file(filename,key)
# Se Genera un valor aletaorio para la llave con la libreria de NaCl
signing_key = SigningKey.generate()
texto="Test.enc"
# Se firma el archivo con la llave previamente generada
signed = signing_key.sign(b"texto")
#Se guarda el valor de el archivo firmado en un nuevo documento
dict1 = signed
file1 = open("Encryp_Signed_Test.txt", "wb")
pickle.dump(dict1, file1)
file1.close
print("Archivo encriptado y firmado con NacL")
print(bytes(signed))
